...
const AdminSideBar = ({ onElectionMgtClick, onCandidateMgtClick, onDashboardClick }) => {
    return (
        <aside class="flex flex-col w-1/4 h-screen px-4 py-8 overflow-y-auto bg-white border-r rtl:border-r-0 rtl:border-l dark:bg-gray-900 dark:border-gray-700">
            ...
            <div class="flex flex-col justify-between flex-1 mt-6">
                <nav>
                    ...
                    >
                        ...
                        <span class="mx-4 font-medium">Election Mangement</span>
                    </a>

                    <a
                        class="flex items-center px-4 py-2 mt-5 text-gray-600 transition-colors duration-300 transform rounded-lg dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700"
                        onClick={onCandidateMgtClick}
                    >
                        <svg
                            class="w-5 h-5"
                            viewBox="0 0 24 24"
